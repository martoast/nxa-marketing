<template>
  <div class="py-24">
    <div class="mx-auto max-w-7xl px-6 lg:px-8">
      <div class="flex flex-col items-center text-center motion-safe:animate-fadeIn">
        <!-- Main Heading -->
        ...
        <p class="mt-6 max-w-2xl text-lg leading-8 text-gray-300">
          Our platform gives you everything you need to drive growth, boost efficiency, and increase revenue. Don't leave your business potential on the table—let's get started.
        </p>
